...
import sysc4005.policies1.AbstractPolicy1;
import sysc4005.random.AbstractRandomStream;

public class SimulationSystem1 {
	...
	private AbstractPolicy1 policy;
	 ...
	 */
	public SimulationSystem1(AbstractRandomStream stream, int timeSlotCount, double probability[], double lambdas[], AbstractPolicy1 policy, int iterations) {
